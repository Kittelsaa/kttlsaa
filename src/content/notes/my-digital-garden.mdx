...
This is my personal wiki/digital garden and I have gotten used to using Digital gardens to 
describe my notes taking process because gardening is not just writing notes, but actively 
finding links between different pieces of knowledge. 

A "digital garden" is, an analogy/framework used to a taking intentional notes.
I have really loved using this system to build my own personal local digital garden, but 
I'm taking a step further by gardening in public, sharing some of my notes & ideas in public, 
...
A collection of digital gardens or tutorials that you can explore in this topic:
The websites/people/articles who inspired me to start my own public digital garden:
